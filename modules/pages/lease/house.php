...
<body class="body-pages">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="aside-rent">
                        ...
                        <button class="btn-primary-o btn-big full" id="add-rent">Contact Host</button>
                    </div>
                </div>
                <div class="clearfix"></div>
                <div class="col-md-8">
                    <div class="box-desc-lease desc-lease-house">
                        <p>
    ...
    <section class="section section-pages">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                        <h4 class="list-heading">Recommended Activity in Jakarta Barat</h4>
                 </div>
             </div>
        </div>
        <div class="list-card">
